...
input[type="checkbox"]{
    ...
    body {
        background-image: url('https://images.pexels.com/photos/10069511/pexels-photo-10069511.jpeg?auto=compress&cs=tinysrgb&w=600'); 
 	...
 	<div class="col-lg-7" style="border-left: 1px solid #ddd;">
    	...
    	<!-- order details -->
    		...
    		<!-- summary --> 
    			...
    			<div>
    				<button target="_blank" type="submit" name="save" class="btn btn-primary btn-lg fa fa-save" id="save"> Save </button>
    			</div>
    		</div> 
    		<!-- end summary -->
     	</div> 
