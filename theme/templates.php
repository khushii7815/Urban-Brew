...
.navbar-pos .navbar-nav > li > a:focus {
  color: #fff;
  background-color: rgba(192, 121, 89, 0.7); /* Semi-transparent hover effect */
}
...
.navbar-pos .navbar-toggle:focus {
  background-color: #444; /* Darker gray for toggle */
}
        ...
        <nav class="navbar navbar-pos  " role="navigation">
            ...
            <div class="navbar-header">
                ...
                if ($_SESSION['ADMIN_ROLE']=='Administrator') {
                  # code...
             ?>
              <a class="navbar-brand" href="../orders/index.php?view=POS/" >
    <?php echo $viewTitle->Title; ?>
</a>
          <?php }
          else if($_SESSION['ADMIN_ROLE']=='Cashier'){ ?>
...
<?php if ($_SESSION['ADMIN_ROLE']=='Cashier' || $_SESSION['ADMIN_ROLE']=='Administrator') { ?> 
                     <li class="<?php echo (isset($_GET['view']) && ($_GET['view'] == 'POS' || $_GET['view'] == 'addmeal')) ? "active" : false; ?>">
